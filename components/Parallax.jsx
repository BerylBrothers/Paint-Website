...
const Parallax = () => {
  return (
    <div className="relative w-full h-[70vh] xl:h-[50vh] bg-cover bg-bottom bg-no-repeat flex items-center py-12 justify-center">
      {/* Dark overlay */}
      ...
      <section className="relative">
        <div
          className="sticky top-0 w-full h-full bg-cover bg-center"
          style={{
            backgroundImage: 'url("/images/logs.jpg")',
            transform: "translateY(-30%)", // Adjust the translateY to control parallax speed
            backgroundAttachment: "fixed", // This will help with the parallax effect on desktop
          }}
        >
