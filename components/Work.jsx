...
const Work = () => {
  return (
    ...
    <div className="container mx-auto h-full">
        <div className='py-12'>
            <h3 className='py-8'>My Work</h3>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            {projects.map((project, index) => {
                return <div className='border border-black' key={index}>
                    <div className='border border-black'>
                    <Image 
                    src={project.image} 
                    alt={project.title} 
                    width={500}  // You can set a fixed width
                    height={350} // You can set a fixed height
